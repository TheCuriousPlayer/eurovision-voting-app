    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#1a1a2e] to-[#16213e] p-8">
      <div className="bg-[#2c3e50] rounded-lg p-8 max-w-xl text-center">
        <h1 className="text-3xl font-bold text-white mb-4">
          Sonuçlar <a href="https://www.youtube.com/@BugraSisman" target="_blank" rel="noopener noreferrer" className="underline text-blue-300 hover:text-blue-500">Buðra Þiþman YouTube</a> kanalýndan izlenebilir.
        </h1>
        <p className="text-gray-300">Bu sayfa 09.10.2025 17:00&apos;a kadar devre dýþý býrakýlmýþtýr.</p>
        <p className="text-3xl font-bold text-gray-300 mb-4">___</p>
        <h1 className="text-3xl font-bold text-white mb-4">
          Results are available on the <a href="https://www.youtube.com/@BugraSisman" target="_blank" rel="noopener noreferrer" className="underline text-blue-300 hover:text-blue-500">Buðra Þiþman YouTube</a> channel.
        </h1>
