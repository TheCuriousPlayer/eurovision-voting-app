...
export default function Page() {
  ...
  const cardWidth = layoutMode === 'vertical' ? 490 : 214;  const cardImageFlex = layoutMode === 'vertical' ? '0 0 210px' : '0 0 auto';  const entries = Object.entries(eurovision2026SF2Songs);
