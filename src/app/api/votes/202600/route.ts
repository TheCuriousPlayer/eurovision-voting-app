...
// Use Eurovision 2026 Preview (year code 202600) for all database operations
const EUROVISION_YEAR = 202600;
...
export async function POST(request: Request) {
  try {
    ...
    // Store vote in database for Eurovision 2026 Preview
...
export async function GET() {
  try {
    ...
    // Get cumulative results from database for Eurovision 2026 Preview
