...
// Use Eurovision 2020 year for all database operations
...
export async function POST(request: Request) {
  try {
    ...
    // Store vote in database for Eurovision 2020
...
export async function GET() {
  try {
    ...
    // Get cumulative results from database for Eurovision 2020
