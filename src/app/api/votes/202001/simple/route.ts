...
export async function GET() {
  try {
    ...
    // Get the 2020 Semi-Final A competition by year
    const competition = await prisma.competition.findFirst({
      where: { year: 202001 }
    });

    if (!competition) {
      console.error('202001 competition not found in database');
    ...
    console.log('Database query results for 202001:');
    ...
    const voteConfig = VOTE_CONFIG['202001'];
    ...
    console.log('Final API response for 202001:', {
      ...responsePayload,
    ...
    console.error('Error in simple API for 202001:', error);
