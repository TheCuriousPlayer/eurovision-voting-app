...
// Use Eurovision 2022 year for all database operations
...
export async function POST(request: Request) {
  try {
    ...
    // Store vote in database for Eurovision 2022
...
export async function GET() {
  try {
    ...
    // Get cumulative results from database for Eurovision 2022
