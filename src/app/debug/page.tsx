...
export default function DebugPage() {
        ...
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              Debug sayfasýna eriþmek için giriþ yapmanýz gerekmektedir.
            </p>
            <button
  ...
  // Admin kontrolü - yalnýzca belirli e-posta adreslerine izin verilir
      ...
      <div className="min-h-screen bg-gray-100 p-6">
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-4">Yetkisiz Eriþim</h1>
            <p className="text-gray-600 mb-6">
              Bu sayfaya eriþim yetkiniz bulunmamaktadýr. Yalnýzca sistem yöneticileri bu sayfayý görüntüleyebilir.
            </p>
            <div className="text-sm text-gray-500">
              Giriþ yapýlan hesap: {session.user?.email}
            </div>
          </div>
        </div>
      </div>
